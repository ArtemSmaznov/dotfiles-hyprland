...
Dwindle
#+begin_src conf
bind = ALT , space , exec , $myHyprScript/toggle-layout.sh # switch layouts
#+end_src
...
submap = toggle
bind =       , b , exec   , $myHyprScript/toggle-borders.sh $borders                                                # toggle window borders
bind =       , c , exec   , $myHyprScript/toggle-corners.sh $corners                                                # toggle corners
bind =       , g , exec   , $myHyprScript/toggle-gaps.sh $gaps_inner                                                # toggle gaps
...
bind =       , s , exec   , $myHyprScript/toggle-status-bar.sh                                                      # toggle status bar
bind =       , z , exec   , $myHyprScript/toggle-zen.sh $borders $corners $gaps_inner                               # toggle zen mode
...
bind = , b , exec , $myScript/btctl.sh toggle           # toggle bluetooth
bind = , e , exec , $myScript/netctl.sh toggle ethernet # toggle ethernet
bind = , h , exec , $myScript/toggle-headphones.sh      # toggle bluetooth headphones
bind = , s , exec , $myScript/toggle-speakers.sh        # toggle bluetooth speakers
bind = , v , exec , $myScript/vpnctl.sh toggle          # toggle vpn
bind = , w , exec , $myScript/netctl.sh toggle wifi     # toggle wi-fi
...
#+begin_src conf
submap = panels
bind =       , m , exec , $myEwwScript/toggle-window.sh -m $($myScript/get-current-monitor.sh id) $panel-monitor  # toggle quick-settings panel
bind = SHIFT , M , exec , $myEwwScript/toggle-window.sh -m 1 $panel-monitor                                       # toggle quick-settings panel on secondary monitor
bind =       , q , exec , $myEwwScript/toggle-window.sh -m $($myScript/get-current-monitor.sh id) $quick-settings # toggle quick-settings panel
bind = SHIFT , Q , exec , $myEwwScript/toggle-window.sh -m 1 $quick-settings                                      # toggle quick-settings panel on secondary monitor
