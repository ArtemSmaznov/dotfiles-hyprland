...
bind = , m , exec , $myHyprScript/toggle-special-workspace.sh "music"      "sp-music"            "alacritty --class sp-music -e ncmpcpp" # toggle music player
...
bind = , catchall , exec , $myHyprScript/reset-submap.sh
