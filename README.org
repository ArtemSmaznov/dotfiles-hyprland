...
decoration {
    ...
    col.shadow = rgba(1a1a1aee)           # shadow’s color. Alpha dictates shadow’s opacity.

    col.shadow_inactive = rgba(1a1a1acc)  # inactive shadow color. (if not set, will fall back to col.shadow) color unset
