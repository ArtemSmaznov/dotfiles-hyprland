...
group {
    # group borders
    col.border_active = rgba($base0Baa) rgba($base0Caa) 90deg
    col.border_inactive = rgba($base0B44) rgba($base0C44) 90deg
...
** XWayland Windows
#+begin_src conf
windowrulev2 = bordercolor rgba($base0Faa) rgba($base0F44),xwayland:1
#+end_src
