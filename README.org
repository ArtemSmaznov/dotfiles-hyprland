...
layerrule = ignorealpha 0, gtk-layer-shell # eww
#+end_src
...
bindl = CTRL , XF86AudioPlay        , exec , $myScript/playerctl.sh single   # [s] Single Mode
bindl = CTRL , XF86AudioStop        , exec , $myScript/playerctl.sh random   # [z] Shuffle Mode
#+end_src
...
bind = , d , exec , $myHyprConfig/toggle-special-workspace.sh "chats"             "discord"                           $myDiscord
bind = , m , exec , $myHyprConfig/toggle-special-workspace.sh "music"             "sp-music"                          "alacritty --class sp-music -e ncmpcpp"
bind = , m , exec , $myHyprConfig/toggle-special-workspace.sh "music"             "sp-clock"                          "alacritty --class sp-clock -e tty-clock -ct -C 3"
bind = , m , exec , $myHyprConfig/toggle-special-workspace.sh "music"             "sp-visualizer"                     "alacritty --class sp-visualizer -e cava"
