...
*** Workspace 5 - Computer
#+begin_src conf
windowrule = workspace 5 silent,^(dolphin)$
windowrule = workspace 5 silent,^(ark)$
windowrule = workspace 5 silent,^(File-roller)$
windowrule = workspace 5 silent,^(googledocs)$
windowrule = workspace 5 silent,^(keep)$
windowrule = workspace 5 silent,^(calendar)$
windowrule = workspace 5 silent,^(thunderbird)$
#+end_src

*** Workspace 6 - Chat
#+begin_src conf
# windowrule   = workspace 6 silent,^(whatsapp-for-linux)$
# windowrule   = workspace 6 silent,^(Slack)$
# windowrule   = workspace 6 silent,^(discord)$
# windowrule   = workspace 6 silent,^(signal)$
# windowrulev2 = workspace 6 silent,class:^([Ss]team)$,title:^(Friends List)$
#+end_src

*** Workspace 7 - Graphics
#+begin_src conf
windowrule = workspace 7 silent,^([Gg]imp)$
windowrule = workspace 7 silent,^(Inkscape)$
windowrule = workspace 7 silent,^(Flowblade)$
windowrule = workspace 7 silent,^(org.kde.digikam)$
windowrule = workspace 7 silent,^(obs)$
windowrule = workspace 7 silent,^(kdenlive)$
#+end_src
