...
#+begin_src conf
submap = group
bindd  =       , g   , group/ungroup              , togglegroup
bindd  =       , tab , next window                , changegroupactive
bindd  =       , l   , toggle group lock          , lockactivegroup     , toggle
bindd  = SHIFT , L   , toggle lock on all groups  , lockgroups          , toggle
bindd  =       , x   , restict window from groups , denywindowfromgroup , toggle
