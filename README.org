...
group {
    ...
    groupbar {
        ...
        gradients = true
        col.active = rgba($base0B77)
        col.inactive = rgba($base0C33)
        col.locked_active = rgba($base09aa)
        col.locked_inactive = rgba($base0F33)
    }
}
#+end_src
...
Groups
#+begin_src conf
bindd = ALT       , tab , focus next window , changegroupactive , f # focus next window
bindd = ALT SHIFT , tab , focus prev window , changegroupactive , b # focus prev window

bindd = SUPER , left  , focus prev window         , changegroupactive , b  # focus prev window
bindd = SUPER , down  , move window down in stack , movegroupwindow   , f  # move window down in stack
bindd = SUPER , up    , move window up in stack   , movegroupwindow   , b  # move window up in stack
bindd = SUPER , right , focus next window         , changegroupactive , f  # focus next window
#+end_src
...
#+begin_src conf
bind = SUPER ALT , h , movewindoworgroup , l # move focused window left
bind = SUPER ALT , j , movewindoworgroup , d # move focused window below
bind = SUPER ALT , k , movewindoworgroup , u # move focused window above
bind = SUPER ALT , l , movewindoworgroup , r # move focused window right
#+end_src
...
submap = toggle
bind = , b , exec   , $myHyprScript/borderctl.sh $borders toggle                # window borders
bind = , c , exec   , $myHyprScript/toggle-corners.sh $corners                   # rounded corners
bind = , g , exec   , $myHyprScript/gapctl.sh $gaps_inner toggle                # window gaps
...
** leader
#+begin_src conf
bind = SUPER , space , exec   , $myEwwScript/which-key.sh leader
bind = SUPER , space , submap , leader

submap = leader
bind   = , e , exec   , $myEwwScript/which-key.sh eww leader
bind   = , e , submap , eww    # +Elkowar's Wacky Widgets
bind   = , l , exec   , $myEwwScript/which-key.sh layout leader
bind   = , l , submap , layout # +layout
bind   = , w , exec   , $myEwwScript/which-key.sh window leader
bind   = , w , submap , window # +window
...
#+begin_src conf
submap = eww
bindd  = , d , toggle debug panel , exec , eww set debug=true           # toggle debug mode
bindd  = , p , open playground    , exec , eww open --toggle playground # open playgroud

bindr = , catchall  , exec   , $myHyprScript/reset-submap.sh
bind  = , backspace , exec   , $myEwwScript/which-key.sh leader
...
#+begin_src conf
submap = layout
bindd  = , d , dwindle       , exec , $myHyprScript/layoutctl.sh set dwindle # dwindle
bindd  = , l , switch layout , exec , $myHyprScript/layoutctl.sh toggle      # switch layout
bindd  = , m , master        , exec , $myHyprScript/layoutctl.sh set master  # master
bind   = , g , exec          , $myEwwScript/which-key.sh gaps layout leader
...
#+begin_src conf
submap = gaps
bindd  =       , g     , toggle      , exec , $myHyprScript/gapctl.sh $gaps_inner toggle   # toggle
bindd  =       , 0     , reset       , exec , $myHyprScript/gapctl.sh $gaps_inner reset    # reset
bindde =       , minus , shrink      , exec , $myHyprScript/gapctl.sh $gaps_inner shrink 1 # shrink
bindde =       , equal , grow        , exec , $myHyprScript/gapctl.sh $gaps_inner grow 1   # grow
bindd  = SHIFT , 0     , disable     , exec , $myHyprScript/gapctl.sh $gaps_inner disable  # disable
bindde = SHIFT , minus , shrink more , exec , $myHyprScript/gapctl.sh $gaps_inner shrink 5 # shrink more
bindde = SHIFT , equal , grow more   , exec , $myHyprScript/gapctl.sh $borders grow 5      # grow more

bindr = , catchall  , exec   , $myHyprScript/reset-submap.sh
bind  = , backspace , exec   , $myEwwScript/which-key.sh layout leader
...
#+begin_src conf
submap = window
bind   = , b , exec   , $myEwwScript/which-key.sh borders window leader
bind   = , b , submap , borders # +borders
bind   = , g , exec   , $myEwwScript/which-key.sh group window leader
bind   = , g , submap , group   # +group
...
#+begin_src conf
submap = borders
bindd  =       , b     , toggle      , exec , $myHyprScript/borderctl.sh $borders toggle   # toggle
bindd  =       , 0     , reset       , exec , $myHyprScript/borderctl.sh $borders reset    # reset
bindde =       , minus , shrink      , exec , $myHyprScript/borderctl.sh $borders shrink 1 # shrink
bindde =       , equal , grow        , exec , $myHyprScript/borderctl.sh $borders grow 1   # grow
bindd  = SHIFT , 0     , disable     , exec , $myHyprScript/borderctl.sh $borders disable  # disable
bindde = SHIFT , minus , shrink more , exec , $myHyprScript/borderctl.sh $borders shrink 5 # shrink more
bindde = SHIFT , equal , grow more   , exec , $myHyprScript/borderctl.sh $borders grow 5   # grow more

bindr = , catchall  , exec   , $myHyprScript/reset-submap.sh
bind  = , backspace , exec   , $myEwwScript/which-key.sh window leader
...
#+begin_src conf
submap = group
bindd  =       , g   , group/ungroup              , togglegroup                  # group/ungroup
bindd  =       , tab , next window                , changegroupactive            # next window
bindd  =       , l   , toggle group lock          , lockactivegroup     , toggle # toggle group lock
bindd  = SHIFT , L   , toggle lock on all groups  , lockgroups          , toggle # toggle lock on all groups
bindd  =       , x   , restict window from groups , denywindowfromgroup , toggle # restict window from groups
