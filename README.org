...
Floating
#+begin_src conf
windowrulev2 = center,class:$app,floating:1
windowrulev2 = keepaspectratio,class:$app,floating:1
windowrulev2 = dimaround,class:$app,floating:1
#+end_src

Tiled
#+begin_src conf
windowrulev2 = pseudo,class:$app,floating:0
#+end_src
...
windowrule = size 50% 80%,$scratchpad
...
# windowrule = workspace special silent,$scratchpad
windowrule = float,$scratchpad
windowrule = size 30% 70%,$scratchpad
windowrule = move 60% 5%,$scratchpad
#+end_src
...
** Toggle Scratchpad
+ [ ] re-review pyprland
+ [ ] allow tiling after second open
  - first toggle spawns the floating app
  - second toggle hides it
  - third toggle opens it as scratchpad
