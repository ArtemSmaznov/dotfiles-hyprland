...
*** Workspace 7 - Gaming
#+begin_src conf
windowrule   = workspace 7 silent,[Bb]attle.net
windowrule   = workspace 7 silent,[Ww]ine
windowrule   = workspace 7 silent,dolphin-emu
windowrule   = workspace 7 silent,Citra
windowrule   = workspace 7 silent,SuperTuxKart
#+end_src
...
** Steam
#+begin_src conf
windowrule = workspace 7 silent,[Ss]team

# steam updater floating window
windowrulev2 = workspace 7 silent,title:Steam,floating:1
...
** Lutris
#+begin_src conf
windowrule   = workspace 7 silent,net.lutris.Lutris
