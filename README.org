...
group {
    ...
    col.border_inactive = rgba($base0B44) rgba($base0D44) rgba($base0C44) 45deg
    ...
    groupbar {
        ...
        gradients = true
        col.active = rgba($base00CC)
        col.inactive = rgba($base0077)
    }
}
#+end_src
...
** XWayland Windows
#+begin_src conf
windowrulev2 = bordercolor rgba($base09aa) rgba($base0Aaa) rgba($base0Faa) 45deg rgba($base0944) rgba($base0A44) rgba($base0F44) 45deg,xwayland:1
#+end_src
