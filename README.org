...
#+begin_src conf
submap = layout
bindd  = , d , dwindle       , exec , $myHyprScript/layoutctl.sh dwindle  # dwindle
bindd  = , l , switch layout , exec , $myHyprScript/layoutctl.sh          # switch layout
bindd  = , m , master        , exec , $myHyprScript/layoutctl.sh master   # master
