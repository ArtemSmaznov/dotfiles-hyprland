...
** XWayland Windows
#+begin_src conf
windowrulev2 = bordercolor rgba($base09aa) rgba($base08aa) rgba($base0Aaa) 45deg,xwayland:1
#+end_src
...
# windowrulev2 = workspace 5 silent,class:class:[Ss]team,title:Friends List.*
#+end_src
...
# floating
windowrulev2 = dimaround,$app_filter,floating:1
windowrulev2 = keepaspectratio,$app_filter,floating:1
windowrulev2 = stayfocused,$app_filter,floating:1
windowrulev2 = center,$app_filter,floating:1

# tiled
windowrulev2 = pseudo,$app_filter,floating:0
...
** Games
#+begin_src conf
windowrulev2 = tag +game-launcher , class:net.lutris.Lutris
windowrulev2 = tag +game-launcher , class:[Ss]team            # game launchers
windowrulev2 = workspace 8 silent , tag:game-launcher

windowrulev2 = tag +steam-floats  , title:Steam,floating:1    # steam updater floating window
windowrulev2 = workspace 8 silent , tag:steam-floats
windowrulev2 = nofocus            , tag:steam-floats

windowrulev2 = float,title:SteamTinkerLaunch                  # float dialogs and stuff

windowrulev2 = tag +misc-game , class:steam_app.*,title:^$    # non-game windows spawned by launching games
windowrulev2 = center         , tag:misc-game

windowrulev2 = tag +game       , class:steam_app.*,title:negative:^$ # game windows
windowrulev2 = renderunfocused , tag:game                            # fix workspace switches for games
...
windowrulev2 = pseudo,$app_filter
windowrulev2 = keepaspectratio,$app_filter
windowrulev2 = opacity override 0.7,$app_filter
windowrulev2 = noborder,$app_filter
#+end_src
...
windowrulev2 = float,$app_filter
windowrulev2 = center,$app_filter
windowrulev2 = size 60% 80%,$app_filter
windowrulev2 = dimaround,$app_filter
#+end_src
