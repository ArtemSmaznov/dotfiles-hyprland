...
bindde =       , minus , decrease , exec , $myHyprScript/borderctl.sh $borders decrease 1  # decrease
bindde =       , equal , increase , exec , $myHyprScript/borderctl.sh $borders increase 1  # increase
bindd  = SHIFT , minus , disable  , exec , $myHyprScript/borderctl.sh $borders disable     # disable
bindd  = SHIFT , equal , double   , exec , $myHyprScript/borderctl.sh $borders double      # double
...
bindde =       , minus , decrease , exec , $myHyprScript/gapctl.sh $gaps_inner decrease 1  # decrease
bindde =       , equal , increase , exec , $myHyprScript/gapctl.sh $gaps_inner increase 1  # increase
bindd  = SHIFT , minus , disable  , exec , $myHyprScript/gapctl.sh $gaps_inner disable     # disable
bindd  = SHIFT , equal , double   , exec , $myHyprScript/gapctl.sh $gaps_inner double      # double
