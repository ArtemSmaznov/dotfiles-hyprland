...
** Submap app-primary
#+begin_src conf
bind = SUPER , o , exec   , $myEwwScript/which-key.sh app-primary
...
bind = , catchall , exec , $myHyprConfig/reset-submap.sh
bind = , c        , exec , $myHyprConfig/reset-submap.sh
bind = , d        , exec , $myHyprConfig/reset-submap.sh
bind = , i        , exec , $myHyprConfig/reset-submap.sh
bind = , m        , exec , $myHyprConfig/reset-submap.sh
bind = , s        , exec , $myHyprConfig/reset-submap.sh
bind = , t        , exec , $myHyprConfig/reset-submap.sh
bind = , v        , exec , $myHyprConfig/reset-submap.sh
bind = , w        , exec , $myHyprConfig/reset-submap.sh
...
bind = , catchall , exec , $myHyprConfig/reset-submap.sh
bind = , e        , exec , $myHyprConfig/reset-submap.sh
bind = , g        , exec , $myHyprConfig/reset-submap.sh
bind = , p        , exec , $myHyprConfig/reset-submap.sh
bind = , r        , exec , $myHyprConfig/reset-submap.sh
bind = , v        , exec , $myHyprConfig/reset-submap.sh
...
bind =       , catchall  , exec , $myHyprConfig/reset-submap.sh
bind =       , backslash , exec , $myHyprConfig/reset-submap.sh
bind =       , b         , exec , $myHyprConfig/reset-submap.sh
bind = SUPER , d         , exec , $myHyprConfig/reset-submap.sh
bind =       , k         , exec , $myHyprConfig/reset-submap.sh
bind =       , n         , exec , $myHyprConfig/reset-submap.sh
bind =       , p         , exec , $myHyprConfig/reset-submap.sh
bind =       , r         , exec , $myHyprConfig/reset-submap.sh
bind =       , s         , exec , $myHyprConfig/reset-submap.sh
bind =       , t         , exec , $myHyprConfig/reset-submap.sh
...
bind =       , catchall  , exec , $myHyprConfig/reset-submap.sh
bind =       , backspace , exec , $myHyprConfig/reset-submap.sh
bind =       , a         , exec , $myHyprConfig/reset-submap.sh
bind = SHIFT , c         , exec , $myHyprConfig/reset-submap.sh
...
bind =       , catchall , exec , $myHyprConfig/reset-submap.sh
bind =       , c        , exec , $myHyprConfig/reset-submap.sh
bind =       , l        , exec , $myHyprConfig/reset-submap.sh
bind =       , p        , exec , $myHyprConfig/reset-submap.sh
bind =       , r        , exec , $myHyprConfig/reset-submap.sh
bind =       , s        , exec , $myHyprConfig/reset-submap.sh
bind =       , z        , exec , $myHyprConfig/reset-submap.sh
bind = SUPER , z        , exec , $myHyprConfig/reset-submap.sh
...
bind =       , q , exec , $myEwwScript/toggle-window.sh -m $($myScript/get-current-monitor.sh id) $quick-settings # toggle status panel
bind = SHIFT , Q , exec , $myEwwScript/toggle-window.sh $quick-settings                                           # toggle status panel on default monitor
...
bindr =       , catchall , exec , $myHyprConfig/reset-submap.sh
bind  =       , b        , exec , $myHyprConfig/reset-submap.sh
bind  =       , c        , exec , $myHyprConfig/reset-submap.sh
bind  =       , g        , exec , $myHyprConfig/reset-submap.sh
bind  =       , h        , exec , $myHyprConfig/reset-submap.sh
bind  =       , q        , exec , $myHyprConfig/reset-submap.sh
bind  = SHIFT , Q        , exec , $myHyprConfig/reset-submap.sh
bind  =       , s        , exec , $myHyprConfig/reset-submap.sh
bind  =       , z        , exec , $myHyprConfig/reset-submap.sh
