...
bind = , g , exec   , $myHyprScript/toggle-gaps.sh $gaps_inner                   # window gaps
...
#+begin_src conf
submap = borders
bindde =       , minus , decrease size , exec , $myHyprScript/bordersctl.sh $borders decrease 1  # decrease size
bindd  = SHIFT , equal , double size   , exec , $myHyprScript/bordersctl.sh $borders double      # double size
bindde =       , equal , increase size , exec , $myHyprScript/bordersctl.sh $borders increase 1  # increase size
