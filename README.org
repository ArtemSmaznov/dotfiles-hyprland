...
exec-once = uwsm app -S both -- eww open-many main-bar $quick-settings
exec-once = $myVisualizer
#+end_src
...
windowrulev2 = idleinhibit always,class:Alacritty,title:cava
#+end_src
...
workspace = 7, persistent:false, monitor:DP-3, default:true , on-created-empty: $mySysLog , bordersize:2 , gapsin:0 , gapsout:0 , rounding:0
