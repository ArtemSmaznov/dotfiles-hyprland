...
bind = SUPER    , grave  , exec , $myHyprConfig/toggle-special-ws.sh "term"   "sp-term"   "alacritty --class sp-term"
bind = SUPER    , e      , exec , $myHyprConfig/toggle-special-ws.sh "files"  "sp-files"  "alacritty --class sp-files -e vifm"
#+end_src
...
bind = , a , exec , $myHyprConfig/toggle-special-ws.sh "anki"              "anki"                              "anki"
bind = , c , exec , $myHyprConfig/toggle-special-ws.sh "calculator"        "org.gnome.Calculator"              "gnome-calculator"
bind = , d , exec , $myHyprConfig/toggle-special-ws.sh "chats"             "discord"                           $myDiscord
bind = , m , exec , $myHyprConfig/toggle-special-ws.sh "music"             "sp-music"                          "alacritty --class sp-music -e ncmpcpp"
bind = , m , exec , $myHyprConfig/toggle-special-ws.sh "music"             "sp-clock"                          "alacritty --class sp-clock -e tty-clock -ct -C 3"
bind = , m , exec , $myHyprConfig/toggle-special-ws.sh "music"             "sp-visualizer"                     "alacritty --class sp-visualizer -e cava"
bind = , t , exec , $myHyprConfig/toggle-special-ws.sh "torrent"           "com.transmissionbt.transmission"   "transmission-gtk"
bind = , v , exec , $myHyprConfig/toggle-special-ws.sh "vm"                "virt-manager"                      "virt-manager"
bind = , w , exec , $myHyprConfig/toggle-special-ws.sh "chats"             "whatsapp-for-linux"                "whatsapp-for-linux"
...
*** TODO CTRL ALT
#+begin_src conf
bind = CTRL ALT , delete , exec                   , $myHyprConfig/toggle-special-ws.sh "htop"  "sp-htop"  "alacritty --class sp-htop -e htop"
bind = CTRL ALT , end    , exec                   , $myHyprConfig/toggle-special-ws.sh "btop"  "sp-btop"  "alacritty --class sp-btop -e btop"
...
# bind = CTRL ALT , v      , exec                   , $myHyprConfig/toggle-special-ws.sh "volume" "pavucontrol" "pavucontrol"
# bind = CTRL ALT , v      , exec                   , $myHyprConfig/toggle-special-ws.sh "volume" "pavucontrol" "pavucontrol & qpwgraph"
#+end_src
...
#+begin_src shell :shebang #!/usr/bin/env bash :tangle scripts/toggle-special-ws.sh
workspace_name="$1"
app_class="$2"
app_command="$3"
