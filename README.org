...
$mySysLog        = alacritty --class syslog -e journalctl --follow
$myCliText       = vim
...
#+begin_src conf
$app_filter = ^(syslog)$
windowrulev2 = fullscreen,class:$app_filter
#+end_src
...
workspace = 7, persistent:false, monitor:DP-3, on-created-empty: $mySysLog
