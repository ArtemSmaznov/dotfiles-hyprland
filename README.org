...
** Pinned windows
#+begin_src conf
windowrule = bordersize $borders_dialog,pinned:1
#+end_src
...
*** Workspace 2 - Mail
#+begin_src conf
windowrule = workspace 2 silent,class:org.mozilla.Thunderbird
#+end_src
...
Lutris
#+begin_src conf
# windowrule = size 20% 90% , class:net.lutris.Lutris,floating:1
#+end_src
...
** Thunderbird
#+begin_src conf
$app_filter = class:org.mozilla.Thunderbird,title:.*Filters.*
...
** Wofi
#+begin_src conf
$app_filter = class:wofi
windowrule = dimaround,$app_filter
windowrule = stayfocused,$app_filter
windowrule = pin,$app_filter
#+end_src
...
workspace = 7 , persistent:false , monitor:DP-1 , gapsin:100 , gapsout:200 , bordersize:3 , on-created-empty: $myCliMusic
workspace = 8 , persistent:true  , monitor:DP-1
workspace = 9 , persistent:false , monitor:DP-3 , default:true , bordersize:2 , gapsin:0 , gapsout:0 , rounding:0 , on-created-empty: $mySysLog
#+end_src
