...
hl.bind("SUPER + SHIFT + CTRL + 1", hl.dsp.window.move({ workspace = 1,  follow = true }), { description = "move window to workspace 1 with switch" })
hl.bind("SUPER + SHIFT + CTRL + 2", hl.dsp.window.move({ workspace = 2,  follow = true }), { description = "move window to workspace 2 with switch" })
hl.bind("SUPER + SHIFT + CTRL + 3", hl.dsp.window.move({ workspace = 3,  follow = true }), { description = "move window to workspace 3 with switch" })
hl.bind("SUPER + SHIFT + CTRL + 4", hl.dsp.window.move({ workspace = 4,  follow = true }), { description = "move window to workspace 4 with switch" })
hl.bind("SUPER + SHIFT + CTRL + 5", hl.dsp.window.move({ workspace = 5,  follow = true }), { description = "move window to workspace 5 with switch" })
hl.bind("SUPER + SHIFT + CTRL + 6", hl.dsp.window.move({ workspace = 6,  follow = true }), { description = "move window to workspace 6 with switch" })
hl.bind("SUPER + SHIFT + CTRL + 7", hl.dsp.window.move({ workspace = 7,  follow = true }), { description = "move window to workspace 7 with switch" })
hl.bind("SUPER + SHIFT + CTRL + 8", hl.dsp.window.move({ workspace = 8,  follow = true }), { description = "move window to workspace 8 with switch" })
hl.bind("SUPER + SHIFT + CTRL + 9", hl.dsp.window.move({ workspace = 9,  follow = true }), { description = "move window to workspace 9 with switch" })
hl.bind("SUPER + SHIFT + CTRL + 0", hl.dsp.window.move({ workspace = 10, follow = true }), { description = "move window to workspace 10 with switch" })
...
hl.define_submap("dm-global", function()
  ...
  hl.bind("catchall"  , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { release = true, description = "" })
  hl.bind("backslash" , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
  hl.bind("a"         , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
  hl.bind("b"         , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
  hl.bind("SUPER + d" , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
  hl.bind("k"         , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
  hl.bind("n"         , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
  hl.bind("p"         , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
  hl.bind("r"         , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
  hl.bind("s"         , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
  hl.bind("t"         , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
  hl.bind("w"         , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
...
hl.define_submap("open", function()
  ...
  hl.bind("e"         , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
  hl.bind("i"         , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
  hl.bind("m"         , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
  hl.bind("SHIFT + M" , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
  hl.bind("t"         , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
...
hl.define_submap("games", function()
  ...
  hl.bind("d"        , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh")            , { description = "" })
  hl.bind("f"        , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh")            , { description = "" })
  hl.bind("g"        , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh")            , { description = "" })
  hl.bind("h"        , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh")            , { description = "" })
...
hl.define_submap("dm-power", function()
  ...
  hl.bind("s"         , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
  hl.bind("z"         , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
  hl.bind("SUPER + z" , hl.dsp.exec_cmd(myHyprScript .. "/reset-submap.sh"), { description = "" })
end)
--------------------------------------------------------------------------------
