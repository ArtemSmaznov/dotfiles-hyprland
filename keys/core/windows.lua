...
hl.bind("SUPER + SHIFT + F11", hl.dsp.window.fullscreen_state({ internal = -1, client = 2, action = "toggle" }), { description = "toggle fake fullscreen" })
hl.bind("SUPER + F11"        , hl.dsp.window.fullscreen(), { description = "toggle fullscreen" })
hl.bind("SUPER + SHIFT + f"  , hl.dsp.window.fullscreen(), { description = "toggle fullscreen" })
hl.bind("SUPER + m"          , hl.dsp.window.fullscreen({ mode = "maximized" }), { description = "toggle maximize" })
