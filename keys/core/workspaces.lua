-- focus
hl.bind("SUPER + tab", hl.dsp.focus({ workspace = "previous_per_monitor" })        , { description = "toggle last workspace" })
...
hl.bind("SUPER + SHIFT + CTRL + 1", hl.dsp.window.move({ workspace = 1  }), { description = "move window & switch to workspace 1"  })
hl.bind("SUPER + SHIFT + CTRL + 2", hl.dsp.window.move({ workspace = 2  }), { description = "move window & switch to workspace 2"  })
hl.bind("SUPER + SHIFT + CTRL + 3", hl.dsp.window.move({ workspace = 3  }), { description = "move window & switch to workspace 3"  })
hl.bind("SUPER + SHIFT + CTRL + 4", hl.dsp.window.move({ workspace = 4  }), { description = "move window & switch to workspace 4"  })
hl.bind("SUPER + SHIFT + CTRL + 5", hl.dsp.window.move({ workspace = 5  }), { description = "move window & switch to workspace 5"  })
hl.bind("SUPER + SHIFT + CTRL + 6", hl.dsp.window.move({ workspace = 6  }), { description = "move window & switch to workspace 6"  })
hl.bind("SUPER + SHIFT + CTRL + 7", hl.dsp.window.move({ workspace = 7  }), { description = "move window & switch to workspace 7"  })
hl.bind("SUPER + SHIFT + CTRL + 8", hl.dsp.window.move({ workspace = 8  }), { description = "move window & switch to workspace 8"  })
hl.bind("SUPER + SHIFT + CTRL + 9", hl.dsp.window.move({ workspace = 9  }), { description = "move window & switch to workspace 9"  })
hl.bind("SUPER + SHIFT + CTRL + 0", hl.dsp.window.move({ workspace = 10 }), { description = "move window & switch to workspace 10" })
